...
class ApplicationController extends Controller
{
    ...
    public function update(ApplicationRequest $request, $id)
    {
        ...
        if ($request->hasFile('logo')) {
            ...
            // Save the logo image
            Image::make($request_file)->resize(145, 50)->save(storage_path('app/public/' . $path));
            $app->logo = 'storage/' . $path; // Update path for database
        }
        ...
        if ($request->hasFile('sidebar_logo')) {
            ...
            // Save the sidebar logo image
            Image::make($request_file)->resize(250, 80)->save(storage_path('app/public/' . $path));
            $app->sidebar_logo = 'storage/' . $path; // Update path for database
        }
        ...
        if ($request->hasFile('sidebar_collapsed_logo')) {
            ...
            // Save the sidebar collapsed logo image
            Image::make($request_file)->resize(37, 37)->save(storage_path('app/public/' . $path));
            $app->sidebar_collapsed_logo = 'storage/' . $path; // Update path for database
        }
        ...
        if ($request->hasFile('login_image')) {
            ...
            // Save the login image
            Image::make($request_file)->save(storage_path('app/public/' . $path));
            $app->login_image = 'storage/' . $path; // Update path for database
        }
        ...
        if ($request->hasFile('favicon')) {
            ...
            Image::make($request_file)->resize(60, 60)->save(storage_path('app/public/' . $path));
            $app->favicon = 'storage/' . $path; // Update path for database
        }
